...
> **R:El número de líneas en el archivo .i es mayor porque el #include completa todo el contenido de las bibliotecas de cabecera (como <stdio.h>, <stdlib.h> y "matematica.h"), junto con todas las dependencias internas que estas traen a su vez. El número de líneas varía según el sistema operativo**
...
> **R:Porque el preprocesador se encarga de eliminar por completo todos los comentarios del codigo fuente reemplazando por un espacio.**
...
> **R:910:    printf("=== Laboratorio de Compilacion en C (v%s) ===\n\n", "1.0");**
...
> **R:"pushl %ebp" y "movl %esp, %ebp" guardar el puntero de marco de pila anterior (ebp) y establecen un nuevo marco para la función actual utilizando la dirección del puntero de pila. "movl _llamadas", "%eax" y "addl $1, %eax" Cargan el valor de la variable global _llamadas en el registro eax e incrementan su valor en 1**
...
> **R:movl    _llamadas, %eax movl    %eax, _llamadas movl    _llamadas, %eax
...
> **R:En programa.o figura como símbolo no definido (U - Undefined) porque ahí solo se la utiliza (se la llama) y el archivo no contiene el código ejecutable de la función. En matematica.o figura en la sección de código text (T) porque es el módulo donde la función fue declarada y definida con su cuerpo de código.**
...
> **R:U ___deregister_frame_info U ___register_frame_info**
...
> **R:Quedan porque son funciones pertenecientes a bibliotecas dinámicas del sistema**
...
> **R: Muestra todo el print del main**
...
> **R:Una macro función es una sustitución textual sin verificación de tipos que desaparece en el preprocesamiento, mientras que una función real posee tipos de datos definidos y desaparece como símbolo tras el enlazado al integrarse en el binario final.**
...
> **R:Un T representa codigo ejecutable mientras que un D representa datos**
...
> **R:No hizo falta especificar libc explícitamente porque gcc actúa como un driver que la enlaza automáticamente por defecto.**
